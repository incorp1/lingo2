...
const CACHE = "lingo-cards-v3.20.8";
const APP_SHELL = [
  "./",
  "./index.html",
  "./theme-init.js?v=3.20.8",
  "./css/base.css?v=3.20.8",
  "./css/study.css?v=3.20.8",
  "./css/decks.css?v=3.20.8",
  "./css/stats-settings.css?v=3.20.8",
  "./css/features.css?v=3.20.8",
  "./css/polish.css?v=3.20.8",
  "./css/mobile.css?v=3.20.8",
  "./css/edge-menu.css?v=3.20.8",
  "./css/settings-responsive.css?v=3.20.8",
  "./css/settings-polish.css?v=3.20.8",
  "./css/deck-browser-vA.css?v=3.20.8",
  "./css/card-editor.css?v=3.20.8",
  "./css/motion.css?v=3.20.8",
  "./manifest.webmanifest",
  "./icon-192.png",
  "./icon-512.png",
  "./select-arrow.png",
  "./fsrs.js?v=3.20.8",
  "./languages.js?v=3.20.8",
  "./storage.js?v=3.20.8",
  "./seed.js?v=3.20.8",
  "./ai.js?v=3.20.8",
  "./backup.js?v=3.20.8",
  ...
  "./i18n/ru.js?v=3.20.8",
  "./i18n/en.js?v=3.20.8",
  "./i18n/runtime.js?v=3.20.8",
  "./js/state.js?v=3.20.8",
  "./js/scheduler.js?v=3.20.8",
  "./js/settings.js?v=3.20.8",
  "./js/cards.js?v=3.20.8",
  "./js/study.js?v=3.20.8",
  "./js/stats.js?v=3.20.8",
  "./js/ui.js?v=3.20.8",
  "./js/decks.js?v=3.20.8",
  "./js/import-export.js?v=3.20.8",
  "./js/ai-practice.js?v=3.20.8",
  "./js/selection.js?v=3.20.8",
  "./js/edge-menu.js?v=3.20.8",
  "./js/motion.js?v=3.20.8",
  "./js/learning-language.js?v=3.20.8",
  "./js/app-shell.js?v=3.20.8",
  "./tooltips.js?v=3.20.8"
];
