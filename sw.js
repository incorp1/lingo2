...
const CACHE = "lingo-cards-v3.20.9";
const APP_SHELL = [
  "./",
  "./index.html",
  "./theme-init.js?v=3.20.9",
  "./css/base.css?v=3.20.9",
  "./css/study.css?v=3.20.9",
  "./css/decks.css?v=3.20.9",
  "./css/stats-settings.css?v=3.20.9",
  "./css/features.css?v=3.20.9",
  "./css/polish.css?v=3.20.9",
  "./css/mobile.css?v=3.20.9",
  "./css/edge-menu.css?v=3.20.9",
  "./css/settings-responsive.css?v=3.20.9",
  "./css/settings-polish.css?v=3.20.9",
  "./css/deck-browser-vA.css?v=3.20.9",
  "./css/card-editor.css?v=3.20.9",
  "./css/motion.css?v=3.20.9",
  "./manifest.webmanifest",
  "./icon-192.png",
  "./icon-512.png",
  "./select-arrow.png",
  "./fsrs.js?v=3.20.9",
  "./languages.js?v=3.20.9",
  "./storage.js?v=3.20.9",
  "./seed.js?v=3.20.9",
  "./ai.js?v=3.20.9",
  "./backup.js?v=3.20.9",
  ...
  "./i18n/ru.js?v=3.20.9",
  "./i18n/en.js?v=3.20.9",
  "./i18n/runtime.js?v=3.20.9",
  "./js/state.js?v=3.20.9",
  "./js/scheduler.js?v=3.20.9",
  "./js/settings.js?v=3.20.9",
  "./js/cards.js?v=3.20.9",
  "./js/study.js?v=3.20.9",
  "./js/stats.js?v=3.20.9",
  "./js/ui.js?v=3.20.9",
  "./js/decks.js?v=3.20.9",
  "./js/import-export.js?v=3.20.9",
  "./js/ai-practice.js?v=3.20.9",
  "./js/selection.js?v=3.20.9",
  "./js/edge-menu.js?v=3.20.9",
  "./js/motion.js?v=3.20.9",
  "./js/learning-language.js?v=3.20.9",
  "./js/app-shell.js?v=3.20.9",
  "./tooltips.js?v=3.20.9"
];
