...
const CACHE = "lingo-cards-v3.20.5";
const APP_SHELL = [
  "./",
  "./index.html",
  "./theme-init.js?v=3.20.5",
  "./css/base.css?v=3.20.5",
  "./css/study.css?v=3.20.5",
  "./css/decks.css?v=3.20.5",
  "./css/stats-settings.css?v=3.20.5",
  "./css/features.css?v=3.20.5",
  "./css/polish.css?v=3.20.5",
  "./css/mobile.css?v=3.20.5",
  "./css/edge-menu.css?v=3.20.5",
  "./css/settings-responsive.css?v=3.20.5",
  "./css/settings-polish.css?v=3.20.5",
  "./css/deck-browser-vA.css?v=3.20.5",
  "./css/card-editor.css?v=3.20.5",
  "./css/motion.css?v=3.20.5",
  "./manifest.webmanifest",
  "./icon-192.png",
  "./icon-512.png",
  "./select-arrow.png",
  "./fsrs.js?v=3.20.5",
  "./languages.js?v=3.20.5",
  "./storage.js?v=3.20.5",
  "./seed.js?v=3.20.5",
  "./ai.js?v=3.20.5",
  "./backup.js?v=3.20.5",
  ...
  "./i18n/ru.js?v=3.20.5",
  "./i18n/en.js?v=3.20.5",
  "./i18n/runtime.js?v=3.20.5",
  "./js/state.js?v=3.20.5",
  "./js/scheduler.js?v=3.20.5",
  "./js/settings.js?v=3.20.5",
  "./js/cards.js?v=3.20.5",
  "./js/study.js?v=3.20.5",
  "./js/stats.js?v=3.20.5",
  "./js/ui.js?v=3.20.5",
  "./js/decks.js?v=3.20.5",
  "./js/import-export.js?v=3.20.5",
  "./js/ai-practice.js?v=3.20.5",
  "./js/selection.js?v=3.20.5",
  "./js/edge-menu.js?v=3.20.5",
  "./js/motion.js?v=3.20.5",
  "./js/learning-language.js?v=3.20.5",
  "./js/app-shell.js?v=3.20.5",
  "./tooltips.js?v=3.20.5"
];
