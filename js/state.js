...
const defaultSettings = {
  ...
  practiceTopics: "work and career; travel; science and technology; history; art and music; sports; food and cooking; nature and animals; city life and neighbours; family; health; money and shopping; education; ecology; holidays and traditions; internet and social media",
  practiceSituations: "an unexpected meeting in a train station; a lost item in a café; being late and plans falling apart; the first day at a new job; a misunderstanding between neighbours; an important decision; a surprise party; a breakdown far from home; a competition; moving to a new city; an argument and reconciliation; an accidental discovery in a museum; preparing for a big event",
  practiceStyles: "warm, first person; humorous, third person; light irony, blog post; detective intrigue; dramatic, diary entry; inspiring, letter to a friend; nostalgic; business-like; popular science; news report; interview",
  practiceTemperature: 0.9,
  autoTTS: false,
  ttsRate: 0.95,
...
const NUMERIC_RANGES = Object.freeze({
  ...
  practiceTemperature: { ui: [0, 2], import: [0, 2] },
...
const SETTINGS_SCHEMA = Object.freeze({
  ...
  practiceTopics: { type: "string" },
  practiceSituations: { type: "string" },
  practiceStyles: { type: "string" },
  practiceTemperature: { type: "number", ranges: NUMERIC_RANGES.practiceTemperature, step: 0.1 },
